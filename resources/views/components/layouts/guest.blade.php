...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'AbsenKID') }}</title>
        ...
        <style>
            ...
            /* Ditulis sebagai CSS biasa (bukan utility Tailwind) supaya selalu tampil
               walau aset belum di-build ulang setelah perubahan tampilan login. */
        ...
        <div class="min-h-screen flex flex-col justify-center items-center px-4 py-10 relative overflow-hidden">
            ...
            <div class="relative z-10 mb-8 fade-up">
                <a href="/" class="flex flex-col items-center gap-3">
                    <img src="{{ asset('images/dharma-group.png') }}" class="h-11 w-auto object-contain"
            ...
            <p class="relative z-10 mt-8 text-xs text-white/30 fade-up">© {{ date('Y') }} Dharma Group — AbsenKID</p>
        </div>
    </body>
</html>
