...
<label <?php echo e($attributes->merge(['class' => 'block font-medium text-sm text-white/70'])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH /var/www/AbsenKID/resources/views/components/input-label.blade.php ENDPATH**/ ?>