<?php $__env->startSection('title', 'Spin Doorprize'); ?>
<?php $__env->startSection('page-title', 'Kontrol Undian Doorprize'); ?>
...
<div x-data="spinApp()" class="max-w-5xl mx-auto space-y-4">
    ...
    <div class="flex flex-wrap gap-2 items-center justify-between p-3 rounded-xl"
        ...
        <div class="flex items-center gap-3 flex-wrap">
            ...
            <a href="<?php echo e(route('admin.doorprizes.index')); ?>"
            ...
            <a href="<?php echo e(route('admin.doorprizes.create')); ?>"
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e($displayUrl); ?>" target="_blank"
    ...
    <div x-show="mode==='multi'" x-cloak class="space-y-4">
        ...
        <div class="card" style="border-color:rgba(124,58,237,0.25)">
            ...
            <div class="grid lg:grid-cols-3 gap-3 mb-4">
                ...
                <?php $grpDp = $doorprizes->where('type','doorprize'); ?>
                <div class="rounded-xl border p-3 space-y-2" style="border-color:rgba(36,76,107,0.4); background:rgba(36,76,107,0.04)">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $grpDp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center gap-2 p-2 rounded-lg" style="background:rgba(36,76,107,0.07)">
                        <?php if($dp->gambar): ?>
                        <img src="<?php echo e($dp->gambar_url); ?>" class="h-8 w-8 object-contain rounded shrink-0" style="background:rgba(255,255,255,0.5)">
                        <?php else: ?>
                        <span class="text-base shrink-0">🎁</span>
                        <?php endif; ?>
                        <div class="flex-1 min-w-0">
                            <p class="font-semibold text-xs truncate"><?php echo e($dp->nama_hadiah); ?></p>
                            <p class="text-xs" style="color:#7B91A1">Stok: <?php echo e($dp->jumlah); ?></p>
                        </div>
                        <div class="flex items-center gap-1 shrink-0">
                            <button type="button"
                                    @click="multiDecrement(<?php echo e($dp->id); ?>, <?php echo \Illuminate\Support\Js::from($dp->nama_hadiah)->toHtml() ?>, '<?php echo e($dp->gambar_url); ?>', '<?php echo e($dp->type); ?>')"
                                    class="w-6 h-6 rounded font-bold text-sm leading-none" style="background:rgba(123,145,161,0.15); color:#7B91A1">−</button>
                            <span class="w-5 text-center font-black text-sm" x-text="multiQty(<?php echo e($dp->id); ?>)"></span>
                            <button type="button"
                                    @click="multiIncrement(<?php echo e($dp->id); ?>, <?php echo \Illuminate\Support\Js::from($dp->nama_hadiah)->toHtml() ?>, '<?php echo e($dp->gambar_url); ?>', '<?php echo e($dp->type); ?>')"
                ...
                <?php $grpDu = $doorprizes->where('type','doorprize_utama'); ?>
                <div class="rounded-xl border p-3 space-y-2" style="border-color:rgba(100,116,139,0.4); background:rgba(100,116,139,0.04)">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $grpDu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <?php $grpGp = $doorprizes->where('type','grand_prize'); ?>
                <div class="rounded-xl border p-3 space-y-2" style="border-color:rgba(245,158,11,0.4); background:rgba(245,158,11,0.03)">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $grpGp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="grid lg:grid-cols-2 gap-3 mb-4">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-1.5 mt-1.5 max-h-20 overflow-y-auto">
                        <?php $__currentLoopData = $jabatanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-1.5 px-2 py-1 rounded-lg text-xs cursor-pointer" style="background:rgba(123,145,161,0.08)">
                            <input type="checkbox" x-model="multiExcludedJabatan" value="<?php echo e($jab); ?>" class="w-3.5 h-3.5 rounded" style="accent-color:#D03F42">
                            <?php echo e($jab); ?>
        ...
        <div class="space-y-4">
            ...
            <div class="card">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <a href="<?php echo e(route('admin.doorprizes.create')); ?>" class="text-xs" style="color:#D03F42">+ Tambah</a>
                </div>
                <div class="space-y-2 max-h-64 overflow-y-auto">
                    <?php $__empty_1 = true; $__currentLoopData = $doorprizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div x-show="mode === '<?php echo e($dp->type); ?>'">
                        <button
                            @click="selectPrize(<?php echo e($dp->id); ?>, <?php echo \Illuminate\Support\Js::from($dp->nama_hadiah)->toHtml() ?>, '<?php echo e($dp->gambar_url); ?>', <?php echo e($dp->jumlah); ?>, '<?php echo e($dp->type); ?>')"
                            :style="selectedPrize?.id === <?php echo e($dp->id); ?>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <?php if($dp->gambar): ?>
                                <img src="<?php echo e($dp->gambar_url); ?>" class="h-10 w-10 object-contain rounded-lg shrink-0" style="background:rgba(255,255,255,0.5)">
                                <?php else: ?>
                                <span class="text-2xl shrink-0"><?php echo e(['doorprize' => '🎁', 'doorprize_utama' => '🥈', 'grand_prize' => '🏆'][$dp->type] ?? '🎁'); ?></span>
                                <?php endif; ?>
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-sm truncate"><?php echo e($dp->nama_hadiah); ?></p>
                                    <p class="text-xs" style="color:#7B91A1">Qty: <?php echo e($dp->jumlah); ?></p>
                                </div>
                                <a href="<?php echo e(route('admin.doorprizes.edit', $dp)); ?>"
                    ...
                    <div class="text-center py-4">
                        ...
                        <a href="<?php echo e(route('admin.doorprizes.create')); ?>" class="text-sm font-semibold" style="color:#D03F42">+ Tambah Hadiah</a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="card" x-show="mode==='doorprize_utama' || mode==='grand_prize'" x-cloak
                ...
                <div class="space-y-1.5 max-h-48 overflow-y-auto">
                    <?php $__currentLoopData = $subcoList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="flex items-center gap-2 cursor-pointer text-sm">
                        <input type="checkbox" x-model="selectedSubcos" value="<?php echo e($sc); ?>"
                               class="w-4 h-4 rounded" style="accent-color:#f59e0b">
                        <span><?php echo e($sc); ?></span>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                <?php if($subcoList->isEmpty()): ?>
            ...
            <div class="card">
                ...
                <div class="space-y-1.5 max-h-48 overflow-y-auto">
                    <?php $__currentLoopData = $jabatanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="flex items-center gap-2 cursor-pointer text-sm">
                        <input type="checkbox" x-model="excludedJabatan" value="<?php echo e($jab); ?>"
                               class="w-4 h-4 rounded" style="accent-color:#D03F42">
                        <span><?php echo e($jab); ?></span>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($jabatanList->isEmpty()): ?>
    ...
    <div class="card">
        <div class="flex items-center justify-between mb-4">
            <div>
                ...
                <p class="text-xs mt-0.5" style="color:#7B91A1"><?php echo e($winners->count()); ?> pemenang tercatat · event aktif</p>
            </div>
            <?php if(auth()->user()->hasRole('admin')): ?>
            <form method="POST" action="<?php echo e(route('admin.doorprizes.resetWinners')); ?>"
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php $__currentLoopData = $winners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-b transition-colors" style="border-color:rgba(123,145,161,0.1)"
                        ...
                        <?php $meta = $typeMeta[$w->doorprize->type] ?? $typeMeta['doorprize']; ?>
                        <td class="py-3 px-3 text-center font-bold" style="color:<?php echo e($meta['color']); ?>">
                            <?php if($i === 0): ?> 🥇 <?php elseif($i === 1): ?> 🥈 <?php elseif($i === 2): ?> 🥉 <?php else: ?> <?php echo e($i + 1); ?> <?php endif; ?>
                        </td>
                        <td class="py-3 px-3">
                            <div class="flex items-center gap-2">
                                <?php if($w->doorprize->gambar): ?>
                                    <img src="<?php echo e($w->doorprize->gambar_url); ?>" class="h-9 w-9 object-contain rounded-lg"
                                         style="background:rgba(123,145,161,0.1)">
                                <?php else: ?>
                                    <span class="text-xl"><?php echo e($meta['emoji']); ?></span>
                                <?php endif; ?>
                                <div>
                                    <p class="font-semibold text-sm"><?php echo e($w->doorprize->nama_hadiah); ?></p>
                                    <span class="text-xs px-1.5 py-0.5 rounded-full"
                                          style="background:<?php echo e($meta['badgeBg']); ?>; color:<?php echo e($meta['badgeColor']); ?>">
                        ...
                        <td class="py-3 px-3 font-mono text-xs" style="color:#40647E"><?php echo e($w->employee->npk); ?></td>
                        <td class="py-3 px-3 font-semibold"><?php echo e($w->employee->nama); ?></td>
                        <td class="py-3 px-3"><span class="badge-blue"><?php echo e($w->employee->subco); ?></span></td>
                        <td class="py-3 px-3 text-center text-xs" style="color:#7B91A1"><?php echo e($w->won_at->format('H:i:s')); ?></td>
                        <td class="py-3 px-3 text-center">
                            <?php if(auth()->user()->hasRole('admin')): ?>
                            <form method="POST" action="<?php echo e(route('admin.doorprizes.destroyWinner', $w)); ?>"
                                  onsubmit="return confirm('Hapus pemenang <?php echo e(addslashes($w->employee->nama)); ?>?')">
...
function spinApp() {
    return {
        ...
        excludedJabatan: [],
        selectedSubcos: [],
        allJabatan: <?php echo json_encode($jabatanList, 15, 512) ?>,
        savedWinners: [],
        eligibleCount: <?php echo e($eligibleCount); ?>,
        winnerIndex: 0,
        displayNpk: '',
        displaySubco: '',
        _pool: [], _poolIdx: 0, _interval: null, _resolved: null,
        doorprizes: <?php echo json_encode($doorprizes, 15, 512) ?>,
        subcoEligibleCounts: <?php echo json_encode($subcoEligibleCounts, 15, 512) ?>,
        ...
        async multiDrawAndStart() {
            ...
            try {
                const drawRes = await fetch('<?php echo e(route('admin.doorprizes.multiDraw')); ?>', {
                    method: 'POST',
                ...
                const startRes = await fetch('<?php echo e(route('admin.doorprizes.multiStart')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
                ...
                const statusRes  = await fetch('<?php echo e(route('doorprizes.displayStatus')); ?>?_=' + Date.now());
        ...
        async multiStopSlot(slotId) {
            this.multiBusy = true;
            try {
                const res = await fetch('<?php echo e(route('admin.doorprizes.multiStopSlot')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
        ...
        async multiStopAll() {
            this.multiBusy = true;
            try {
                const res = await fetch('<?php echo e(route('admin.doorprizes.multiStopAll')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
                });
        ...
        async multiResetSlot(slotId) {
            this.multiBusy = true;
            try {
                const res = await fetch('<?php echo e(route('admin.doorprizes.multiResetSlot')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
        ...
        async multiResetAllSlots() {
            ...
            this.multiBusy = true;
            try {
                await fetch('<?php echo e(route('admin.doorprizes.multiResetAll')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
                });
                clearInterval(this._multiInterval);
        ...
        async multiSaveAll() {
            this.multiBusy = true;
            try {
                const res = await fetch('<?php echo e(route('admin.doorprizes.multiSaveWinners')); ?>', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
                });
                const data = await res.json();
        ...
        async startSpin() {
            ...
            const res = await fetch('<?php echo e(route('admin.doorprizes.draw')); ?>', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
                body: JSON.stringify({
        ...
        async saveWinner() {
            ...
            this.saving = true;
            const res = await fetch('<?php echo e(route('admin.doorprizes.saveWinner')); ?>', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>', 'Accept': 'application/json' },
        ...
        async syncDisplay(action, sampleNpk = null, winnerData = null) {
            try {
                if (action === 'start') {
                    await fetch('<?php echo e(route('admin.doorprizes.startDisplay')); ?>', {
                        method: 'POST',
                    ...
                    await fetch('<?php echo e(route('admin.doorprizes.stopDisplay')); ?>', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' },
                        body: JSON.stringify({ winner: winnerData })
                    });
                } else {
                    await fetch('<?php echo e(route('admin.doorprizes.resetDisplay')); ?>', {
                        method: 'POST', headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' }, body: '{}'
                    });
                }
            } catch (e) {}
        },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/AbsenKID/resources/views/admin/doorprizes/spin.blade.php ENDPATH**/ ?>